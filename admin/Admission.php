...
<form name="feedview" method="post" action="del_add1.php" onSubmit="return fundel()">
<center>
<caption><h2>Admission Form</h2></caption>
<table>
<tr>
	<th>
	<?php
...
<tr>
	<td>
		<?php
			...
			echo "<tr><th> All Delete</th> <th>Id</th>  <th>SurName</th> <th>Name</th> <th>Father Name</th> 
			<th>Number</th> <th>E-mail</th> <th>Gender</th> <th>Category</th> <th>Standard</th> <th>Percentage</th> 
			...
			while($row=mysqli_fetch_array($res))
			{
				...
				echo "<td><a href='del_add.php?id=$row[0]'>Delete</a></td>";
				echo "</tr>";	
			}
