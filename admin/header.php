                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
						...
						<li>
							...
							<i class="glyphicon glyphicon-th"></i><span> Faculty</span></a>
                        </li>
						...
						<li>
							<a class="ajax-link" href="Register.php">
							<i class="glyphicon glyphicon-lock"></i><span> Register</span></a>
                        </li>
						...
						<li>
							<a class="ajax-link" href="Admission.php">
							<i class="glyphicon glyphicon-list-alt"></i><span> Admission</span></a>
                        </li>
						
						<li>
							<a class="ajax-link" href="Contact.php">
							<i class="glyphicon glyphicon-book"></i><span> Contact</span></a>
                        </li>
