...
<table>
<tr>
	<th><h2 align="center">EDIT PRODUCT</h2></th>
</tr><tr>
...
<tr><td><br/></td></tr>
<tr>
	<td><input type="submit" name="submit" class="btn btn-success btn-lg" value="Update Record"/></td>
	<td><input type="reset" name="reset" class="btn btn-success btn-lg" value="Cancel"/></td>
</tr>
</table>
</form>
<?php 
